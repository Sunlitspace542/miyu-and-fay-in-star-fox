...
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (USA).sfc" "SF_MSU.SFC" ".\releases\Release %VER%\USA Patches\sf_msu1_usa_fast.bps"
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (USA).sfc" "SF_10MSU.SFC" ".\releases\Release %VER%\USA Patches\sf_msu1_usa_slow.bps"
...
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (USA) (Rev 1).sfc" "SF_MSU.SFC" ".\releases\Release %VER%\USA Patches\sf_msu1_usa_rev1_fast.bps"
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (USA) (Rev 1).sfc" "SF_10MSU.SFC" ".\releases\Release %VER%\USA Patches\sf_msu1_usa_rev1_slow.bps"
...
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (USA) (Rev 2).sfc" "SF_MSU.SFC" ".\releases\Release %VER%\USA Patches\sf_msu1_usa_rev2_fast.bps"
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (USA) (Rev 2).sfc" "SF_10MSU.SFC" ".\releases\Release %VER%\USA Patches\sf_msu1_usa_rev2_slow.bps"
...
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (Japan).sfc" "SF_MSU.SFC" ".\releases\Release %VER%\Japan Patches\sf_msu1_jpn_fast.bps"
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (Japan).sfc" "SF_10MSU.SFC" ".\releases\Release %VER%\Japan Patches\sf_msu1_jpn_slow.bps"
...
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (Japan) (Rev 1).sfc" "SF_MSU.SFC" ".\releases\Release %VER%\Japan Patches\sf_msu1_jpn_rev1_fast.bps"
.\flips.exe --create --bps-delta ".\baseroms\Star Fox (Japan) (Rev 1).sfc" "SF_10MSU.SFC" ".\releases\Release %VER%\Japan Patches\sf_msu1_jpn_rev1_slow.bps"
...
.\flips.exe --create --bps-delta ".\baseroms\Starwing (Europe).sfc" "SF_MSU.SFC" ".\releases\Release %VER%\PAL Patches\sf_msu1_pal_fast.bps"
.\flips.exe --create --bps-delta ".\baseroms\Starwing (Europe).sfc" "SF_10MSU.SFC" ".\releases\Release %VER%\PAL Patches\sf_msu1_pal_slow.bps"
...
.\flips.exe --create --bps-delta ".\baseroms\Starwing (Europe) (Rev 1).sfc" "SF_MSU.SFC" ".\releases\Release %VER%\PAL Patches\sf_msu1_pal_rev1_slow.bps"
.\flips.exe --create --bps-delta ".\baseroms\Starwing (Europe) (Rev 1).sfc" "SF_10MSU.SFC" ".\releases\Release %VER%\PAL Patches\sf_msu1_pal_rev1_slow.bps"
...
.\flips.exe --create --bps-delta ".\baseroms\Starwing (Germany).sfc" "SF_MSU.SFC" ".\releases\Release %VER%\PAL Patches\sf_msu1_de_slow.bps"
.\flips.exe --create --bps-delta ".\baseroms\Starwing (Germany).sfc" "SF_10MSU.SFC" ".\releases\Release %VER%\PAL Patches\sf_msu1_de_slow.bps"
